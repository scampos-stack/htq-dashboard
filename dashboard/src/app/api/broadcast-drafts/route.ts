  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        highlight_bullets: Array.isArray(body.highlightBullets) ? body.highlightBullets : [],
        cta_text: body.ctaText || null,
        cta_url: body.ctaUrl || null,
        closing_paragraphs: Array.isArray(body.closingParagraphs) ? body.closingParagraphs : [],
